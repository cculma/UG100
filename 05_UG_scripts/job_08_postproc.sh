...
#SBATCH --job-name="make_examples"   #name of this job
#SBATCH -p atlas
#SBATCH -N 1                  #number of nodes in this job
#SBATCH -n 48                 #number of cores/tasks in this job, you get all 20 physical cores with 2 threads per core with hyper-threading
